...
export default function SideNav({ children }) {
    ...
    return <main className='flex min-h-screen'>
        <aside className={`bg-black text-white w-2/12 sm:w-1/2 ${width}`}>
            <Link href={'/'} className={`flex text-2xl lg:text-base my-9 items-center gap-2 ml-3 sm:text-base`}>
            ...
            <nav className='flex flex-col text-2xl my-4 gap-2'>
                ...
                <Link href={'/customers'} className={router.pathname.includes('/customers') ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <div className='w-full m-10 sm:m-3'>
            <div className='float-end flex items-center gap-1'>
                <Button onClick={collapseTheSide} className="border-0" size="icon">
                    <ChevronLeftIcon />
                </Button>
                <ModeToggle />
                <Button className="border-0" size="icon">
                    ...
                    >
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent>
                                ...
                                <DropdownMenuItem>My Statements</DropdownMenuItem>
                                <DropdownMenuSeparator />
